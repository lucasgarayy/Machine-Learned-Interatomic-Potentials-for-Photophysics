...
for system in systems:
    ...
    system_input_folder = f'{input_folder}/{system}'
    combine_split_xyz_files(system_input_folder, system_output_folder, duplicate_data= True, filter_sf= False, return_combined= False)