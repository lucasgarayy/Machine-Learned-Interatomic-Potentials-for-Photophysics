...
lr_energy_path = 'oxirane/isolated_system/energies/linear-response'
sf_energy_path = 'oxirane/isolated_system/energies/spin-flip'
geom_path = 'oxirane/isolated_system/geometry_optimisations'
