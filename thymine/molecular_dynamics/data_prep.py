...
input_dir = 'thymine/molecular_dynamics/snapshots_energies'
...
out_dir = 'mace-suite/data/unprocessed_datasets/thymine/molecular_dynamics'
os.makedirs(out_dir, exist_ok=True)

write(f'{out_dir}/thymine_md-es1.xyz', sf_es1)
write(f'{out_dir}/thymine_md-es2.xyz', sf_es2)
...
if sf_es1:
    ...
    raise RuntimeError("No SF data found in 'thymine/molecular_dynamics/snapshots_energies'.")
